...
return [
    ...
    */
    ...
    'menu'=>[
        [
            'text'=>'Categories',
            'icon'=>'fas fa-faw fa-user',
            'module'=>'Menu',
            'permission-slug'=>'categories',
        ...
        [
            ...
            'icon'=>'fas fa-faw fa-user',
            'module'=>'Menu',
            'permission-slug'=>'giftguide',
            'url'=>'admin/giftguide',
            'rbac'=>true
        ],
        [
            'text'=>'Giftees/Gifters',
            'icon'=>'fas fa-faw fa-user',
            'module'=>'Menu',
            'permission-slug'=>'giftees',
            'url'=>'admin/giftee',
            'rbac'=>true
        ],
        [
            ...
            'submenu'=>[
                [
                    'text'=>'Cart Orders',
                    'module'=>'CartOrders',
                    'permission-slug'=>'cart_orders',
                    'url'=>'admin/cart_orders',
                    'rbac'=>true,
                ],
               [
                    'text'=>'Contribution Orders',
                    'module'=>'ContributionOrders',
                    'permission-slug'=>'contribution_orders',
                    'url'=>'admin/contribution_orders',
                    'rbac'=>true,
                ],
                [
                    'text'=>'Gift Offer Orders',
                    'module'=>'GiftOfferOrders',
                    'permission-slug'=>'gift_offer_orders',
                    'url'=>'admin/gift_offer_orders',
                    'rbac'=>true,
                ],
            ],
        ],
