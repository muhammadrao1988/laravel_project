      ...
      <div class="col-md-12">
        <div class="card card-primary card-outline collapsed-card">
          ...
          <div class="card-body" style="display: none;">
            <form action="{{ route('cart_orders.index') }}" method="POST">
              @csrf
              <div class="row">
                <div class="form-group col-md-4">
                  <label for="fromDate">Order Id</label>
                ...
                <div class="form-group col-md-4">
                  ...
                  <select id="orderStatus" class="form-control" style="width: 100%;" >
                    ...
                    <option value="Partially Order Placed">Partially Order Placed</option>
